...
const handleSubmit = async (e) => {
    ...
    return (
        <div className="w-[80%] rounded-lg p-4 mb-[238px] bg-transparent">
            ...
            <div className="h-[185px] overflow-y-auto p-4 rounded-lg flex flex-col border border-gray-400 shadow-lg">
